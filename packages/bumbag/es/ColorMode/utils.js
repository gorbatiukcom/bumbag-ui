...
function getColorModesCSSVariables(theme) {
  ...
  cssVariables = Object.entries(theme.palette.modes || {}).reduce(function (cssVariables, _ref3) {
    ...
    var modeKey = _ref3[0],
        value = _ref3[1];
    return _objectSpread2(_objectSpread2({}, cssVariables), {}, (_objectSpread3 = {}, _objectSpread3["&." + rootElementClassPrefix + "-" + modeKey] = mapCSSVariables(value), _objectSpread3));
  }, cssVariables);
...
export { addColorModeRootElementClassName, getColorFromCSSVariable, getColorModesCSSVariables, getDefaultColorMode, mapCSSVariables };
